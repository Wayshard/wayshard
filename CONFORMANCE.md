...
| Routing selects harness/model on health, negotiated capability, policy, and Jev fit | `internal/routing/router.go` | `TestHardFilterImpossible`, `TestUnauthNotRoutable`, `TestNativeRoutingWithoutSandboxOrProvider` | done |
