...
- ACP terminal/tool callbacks are wired through the Tool Sandbox (Linux process-boundary verified); approval DENY end-to-end, publication crash proof, discovery ProbePolicy, and a true kill-mid-recovery process test remain outstanding.
