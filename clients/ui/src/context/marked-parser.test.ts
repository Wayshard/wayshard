...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[Wayshard](https://wayshard.ai)")).toBe(
    '<p><a href="https://wayshard.ai" class="external-link" target="_blank" rel="noopener noreferrer">Wayshard</a></p>\n',
  )
})
