// Adapted from the imported OpenCode 2 TUI (packages/tui/src/ui/dialog.tsx).
// Wayshard-owned copy; OpenCode runtime/domain imports removed or shimmed.
    ...
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseDown={(evt: { button: number; preventDefault(): void; stopPropagation(): void }) => {
          if (!Flag.WAYSHARD_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
        ...
        onMouseUp={!Flag.WAYSHARD_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
