// Adapted from the imported OpenCode 2 TUI (packages/tui/src/ui/dialog-select.tsx).
...
export function DialogSelect<T>(props: DialogSelectProps<T>) {
  ...
  const scrollAcceleration = createMemo(() => getScrollAcceleration(tuiConfig as never))
        ...
        <Show when={props.renderFilter !== false}>
          <box paddingTop={1}>
            <input
              ...
              cursorStyle={tuiConfig.cursor as never}
