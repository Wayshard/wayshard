...
import type { FileDiffInfo } from "@wayshard/gui/session-ui/sdk/model"
import type { SessionStatus } from "@wayshard/gui/session-ui/sdk/model"
import { useData } from "../context"
import { useFileComponent } from "@wayshard/ui/context/file"

import { Binary } from "@wayshard/gui/session-ui/util/binary"
import { getDirectory, getFilename } from "@wayshard/gui/session-ui/util/path"
import { createEffect, createMemo, createSignal, For, on, ParentProps, Show } from "solid-js"
import { createStore } from "solid-js/store"
import { Dynamic } from "solid-js/web"
import { AssistantParts, Message, MessageDivider, PART_MAPPING, type UserActions } from "./message-part"
import { Card } from "@wayshard/ui/card"
...
import { TextReveal } from "@wayshard/ui/text-reveal"
import { createAutoScroll } from "@wayshard/ui/hooks"
import { useI18n } from "@wayshard/ui/context/i18n"
...
export function SessionTurn(
  ...
  const diffs = createMemo(() => {
    const files = message()?.summary?.diffs as SnapshotFileDiff[] | undefined
