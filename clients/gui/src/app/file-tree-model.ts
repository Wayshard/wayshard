// Wayshard file-tree model.
//
// Adapted from the imported OpenCode 2 graphical client file-tree model
// (third_party/opencode-v1.18.31/packages/app/src/components/file-tree-v2-model.ts):
// the path normalization, tree build and flatten algorithms are retained. The
// node type is Wayshard.
